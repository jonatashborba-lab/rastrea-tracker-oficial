...
const WHATSAPP =
  "https://wa.me/5551999999999?text=Olá! Quero uma cotação de rastreador para motorista de aplicativo.";
      ...
      >
        <div className="px-6">
          <h1 className="text-4xl md:text-6xl font-extrabold drop-shadow-lg">
            Rastreador para motorista de aplicativo
          </h1>

          <p className="mt-4 text-white/90 text-lg drop-shadow">
            Adquira seu rastreador para motorista de aplicativo sem necessidade
        ...
        <div className="mx-auto max-w-6xl px-6 py-16">
          ...
          <div className="mt-16">
            ...
            <p className="mt-4 text-black/80 leading-relaxed text-lg">
              ...
              Temos clientes que possuem seguro e colocam nosso rastreador e
              clientes que até mesmo utilizam dois rastreadores devido a precisão
              e segurança de nosso rastreamento.

              Conte com um sistema de alta qualidade para localizar seu veículo,
              gerar relatórios, verificar percursos, alertas, bloqueio, aplicativo
              e muito mais.

              Dessa forma, você terá um aumento na chance de recuperar seu veículo
              e também realizar um monitoramento veicular completo.
